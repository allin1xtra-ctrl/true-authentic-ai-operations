...
function Settings({ integrations, health, notifications, setNotifications }: any) {
  ...
  const setupDetails = {
    gmail: { title: "Connect Gmail", text: "Enable the Gmail API and register this callback on the Google OAuth web client: https://true-authentic-ai-operations.allin1xtra.chatgpt.site/api/integrations/gmail/callback. Only gmail.readonly is requested; sending remains disabled.", href: "https://console.cloud.google.com/apis/credentials", label: "Open Google Cloud" },
    ...
    calendar: { title: "Connect Google Calendar", text: "Enable the Calendar API and register this callback on the Google OAuth web client: https://true-authentic-ai-operations.allin1xtra.chatgpt.site/api/integrations/calendar/callback. Only calendar-list and event read access is requested.", href: "https://console.cloud.google.com/apis/credentials", label: "Open Google Cloud" },
