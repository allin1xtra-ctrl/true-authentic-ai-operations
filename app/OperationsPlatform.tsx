...
export default function OperationsPlatform() {
  ...
  return <div className="app-shell">
    ...
    <main>
      ...
      {error && <div className="error-banner"><strong>Connection issue</strong><span>{error}</span><button onClick={refresh}>Retry</button></div>}
